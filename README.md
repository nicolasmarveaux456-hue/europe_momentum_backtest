...
- 01_data.ipynb → data download and monthly returns
- 02_factor.ipynb → momentum signal construction
- 03_backtest.ipynb → portfolio construction and performance
- 04_risk_costs.ipynb → drawdown, volatility, transaction costs
- 05_robustness_oos.ipynb → in-sample / out-of-sample testing
- 99_summary.ipynb → final synthesis
